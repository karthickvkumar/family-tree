...
const ɵ0 = () => __webpack_require__.e(/*! import() | feature-module-auth-auth-module-ngfactory */ "feature-module-auth-auth-module-ngfactory").then(__webpack_require__.bind(null, /*! ./feature-module/auth/auth.module.ngfactory */ "./src/app/feature-module/auth/auth.module.ngfactory.js")).then(module => module.AuthModuleNgFactory), ɵ1 = () => __webpack_require__.e(/*! import() | feature-module-home-home-module-ngfactory */ "feature-module-home-home-module-ngfactory").then(__webpack_require__.bind(null, /*! ./feature-module/home/home.module.ngfactory */ "./src/app/feature-module/home/home.module.ngfactory.js")).then(module => module.HomeModuleNgFactory);
const routes = [
    {
        path: '',
        redirectTo: '/login',
...
class TreeAPIService {
    ...
    getAllNode() {
        let url = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiURL + "nodes";
        return this.http.get(url);
    }
    createNode(node) {
        let url = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiURL + "node/add";
        return this.http.post(url, node);
    }
    updateNode(node) {
        let url = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiURL + "node/edit/" + node.id;
...
class TreePageComponent {
    constructor(renderer, treeAPI) {
    ...
    onAddNode(form) {
        try {
            if (this.selectedNode && this.selectedNode.mode === 'edit') {
                ...
                this.treeAPI.updateNode(form.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(() => {
                ...
                this.treeAPI.createNode(form.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(() => {
    ...
    createNode(node) {
        try {
            ...
            let wrapper = new fabric__WEBPACK_IMPORTED_MODULE_3__["fabric"].Rect({
                width: 160, height: 80, fill: node.color
            });
            /*Creating the fabric iText object to create the placeholder for name */
            let namePlaceholder = new fabric__WEBPACK_IMPORTED_MODULE_3__["fabric"].IText(node.name, {
                fontFamily: "Poppins",
                fontSize: 22,
                fill: "white",
                left: 65,
            ...
            let rolePlaceholder = new fabric__WEBPACK_IMPORTED_MODULE_3__["fabric"].IText(node.role, {
                fontFamily: "Poppins",
                fontSize: 18,
                fill: "white",
                left: 65,
            ...
            let groupedView = new fabric__WEBPACK_IMPORTED_MODULE_3__["fabric"].Group([wrapper, namePlaceholder, rolePlaceholder], {
                id: node.id,
                hasBorders: false,
                hasControls: false,
    ...
    getNode() {
        try {
            ...
            let tree = [];
            let res = this.treeAPI.getAllNode().subscribe((respone) => {
                tree = respone;
                this.loading(false);
    ...
    loading(option) {
        try {
            if (option) {
                let looader = new fabric__WEBPACK_IMPORTED_MODULE_3__["fabric"].IText("Loading...", {
                    fontFamily: "Poppins",
                    fontSize: 42,
                    fill: "black",
                    id: 'loading-text',
